...
def evaluate_regression_models(X_train, X_test, y_train, y_test):
    ...
    try:
        ...
        reg = LazyRegressor.LazyRegressor(verbose=0, ignore_warnings=False, custom_metric=None, predictions=True)
        
        # Fit LazyRegressor on the data
        models_df, predictions_df = reg.fit_model(X_train, X_test, y_train, y_test)
